...
<form id="pagerForm" onsubmit="return divSearch(this, 'jbsxBox2module');" action="${ctx}/menu/list/${parentId}" method="post">
...
<form method="post" action="${ctx}/menu/list/${parentId}" onsubmit="return divSearch(this, 'jbsxBox2module');">
...
<div class="pageContent">
	...
	<div class="panelBar">
		...
		<shiro:hasPermission name="Module:save">
			<li><a class="add" target="dialog" width="550" height="350" mask="true" href="${ctx}/menu/create" ><span>添加</span></a></li>
		</shiro:hasPermission>
		<shiro:hasPermission name="Module:edit">
			<li><a class="edit" target="dialog" width="550" height="350" mask="true" href="${ctx }/menu/update/{slt_uid}" ><span>编辑</span></a></li>
		</shiro:hasPermission>
		<shiro:hasPermission name="Module:delete">
			<li><a class="delete" target="ajaxTodo" href="${ctx}/menu/delete/{slt_uid}" title="确认要删除该模块?"><span>删除</span></a></li>
		</shiro:hasPermission>
		</ul>
	</div>
	<table class="table" layoutH="138" width="100%" rel="jbsxBox2module" >
		...
		<tbody>
			<c:forEach var="item" items="${menuModule}">
